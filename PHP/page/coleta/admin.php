            ...
            <table class="table table-bordered table-responsive">
                <thead class="text-center bg-dark text-light">
                    <tr>
                        ...
                        <th class="align-middle" scope="col">Resíduos</th>
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                        <td class="align-middle"><?php echo $line['u_nome']; ?></td>
                        <td class="align-middle"><?php echo $line['u_cell']; ?></td>
                        <td class="align-middle"><?php echo $line['c_resid']; ?></td>
